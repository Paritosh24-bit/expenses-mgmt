...
// Cutoff timestamp to preserve existing production baseline lifetime totals.
// Any claims created after this cutoff will only be added to lifetime total once marked Paid by admin.
export const LIFETIME_BASELINE_CUTOFF = "2026-09-09T17:20:00.000Z";
